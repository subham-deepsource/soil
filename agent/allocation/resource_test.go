...
func TestResource_MarshalLine(t *testing.T) {
	t.Run(`with values`, func(t *testing.T) {
		...
		assert.NoError(t, res.MarshalSpec(&buf))
...
func TestResource_UnmarshalLine(t *testing.T) {
	t.Run(`with values`, func(t *testing.T) {
		...
		assert.NoError(t, r.UnmarshalSpec("### RESOURCE {\"Request\":{\"Name\":\"1\",\"Provider\":\"test\",\"Config\":{\"a\":1}},\"Values\":{\"a\":\"123\"}}\n", allocation.Spec{}, allocation.SystemPaths{}))
	...
	t.Run(`with values no config`, func(t *testing.T) {
		r := &allocation.Resource{}
		assert.NoError(t, r.UnmarshalSpec("### RESOURCE {\"Request\":{\"Name\":\"1\",\"Provider\":\"test\"},\"Values\":{\"a\":\"123\"}}\n", allocation.Spec{}, allocation.SystemPaths{}))
		assert.Equal(t, &allocation.Resource{
			Request: manifest.Resource{
				Provider: "test",
				Name:     "1",
	...
	t.Run(`without values`, func(t *testing.T) {
		r := &allocation.Resource{}
		assert.NoError(t, r.UnmarshalSpec("### RESOURCE {\"Request\":{\"Name\":\"1\",\"Provider\":\"test\",\"Config\":{\"a\":1}}}\n", allocation.Spec{}, allocation.SystemPaths{}))
		assert.Equal(t, &allocation.Resource{
			Request: manifest.Resource{
				Provider: "test",
				Name:     "1",
