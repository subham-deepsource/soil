...
import (
	...
	git "github.com/da-moon/soil/contrib/mage/git"
	primitives "github.com/da-moon/soil/internal/primitives"
...
const (
	packageName = "github.com/da-moon/soil"
)
...
func Target() error {
	...
	for _, bin := range binaries {
		...
		banner.Print()
		fmt.Println("")
		versionpkg := fmt.Sprintf("%s/contrib/mage/version", packageName)
